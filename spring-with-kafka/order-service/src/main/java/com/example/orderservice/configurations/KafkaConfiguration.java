...
public class KafkaConfiguration {
    ...
    @Bean
    public ProducerFactory<String, OrderEvent> orderEventProducerFactory(ObjectMapper mapper) {
    ...
    @Bean
    public ConsumerFactory<String, OrderStatusService> orderStatusServiceConsumerFactory(ObjectMapper mapper) {
        Map<String, Object> config = new HashMap<>();
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderStatusService> orderStatusServiceConcurrentKafkaListenerContainerFactory(
            ConsumerFactory<String, OrderStatusService> orderStatusServiceConsumerFactory
    ){
        ConcurrentKafkaListenerContainerFactory<String, OrderStatusService> factory = new ConcurrentKafkaListenerContainerFactory<>();
